...
SPARQL_USERNAME = "$SPARQL_USERNAME" or None
SPARQL_PASSWORD = "$SPARQL_PASSWORD" or None
SOURCE_NAME = "dawe"
# END Instance Vars
...
VOCS_DESC = "Vocabularies managed and published by the Department of of Agriculture, Water and the Environment"
